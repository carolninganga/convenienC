    ...
    render() {
        return (
            ...
            <ImageUploader
                ...
                withPreview={true}
            />
            {this.state.showSubmitButton ? <button id="btn1" className='btn btn-primary' onClick={()=>{this.props.history.push('/'); alert("Your certificate has been uploaded successfull")}}>submit</button> : ""} 
            </div>
        );
    }
}
